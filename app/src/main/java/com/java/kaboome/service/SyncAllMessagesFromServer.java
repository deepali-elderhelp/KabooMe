 ...
 */
public class SyncAllMessagesFromServer extends IntentService {
     ...
     */
    public SyncAllMessagesFromServer() {
        super("SyncAllMessagesFromServer");
    }
...
//                        lastAccessed.set(lastMessage != null ? lastMessage.getSentAt() : (new Date()).getTime());
                        ...
                        getMessagesFromServer(groupId, userGroup.getCacheClearTS() != null? userGroup.getCacheClearTS() : (new Date()).getTime(), limit, scanDirection, "Group");
