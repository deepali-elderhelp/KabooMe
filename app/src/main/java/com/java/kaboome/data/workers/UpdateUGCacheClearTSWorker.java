 ...
 */
public class UpdateUGCacheClearTSWorker extends Worker {

    private static final String TAG = "KMUpdtUGCacheClearTSWor";
    ...
    public UpdateUGCacheClearTSWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        messagesListRepository.clearMessagesOfGroup(groupId);
        ...
        if(updateUserGroupDAO) {
            ...
            userGroupsListRepository.updateUserGroupCacheClearTS(groupId, cacheCLearTS);
        }
        ...
        if(updateServer){
            ...
            userGroup.setCacheClearTS(cacheCLearTS);


            Call<ResponseBody> call = AppConfigHelper.getBackendApiServiceProvider().updateUserGroup(userId, userGroup, "updateGroupUserClearCache");
            try {
