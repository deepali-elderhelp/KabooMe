...
public abstract class NewNetworkBoundCreateRes<ResultType, RequestType> {

    private static final String TAG = "KMNetworkBoundCreateRes";

    private AppExecutors2 appExecutors;
    private MediatorLiveData<Resource<ResultType>> result = new MediatorLiveData<>();

    public NewNetworkBoundCreateRes(AppExecutors2 appExecutors) {
