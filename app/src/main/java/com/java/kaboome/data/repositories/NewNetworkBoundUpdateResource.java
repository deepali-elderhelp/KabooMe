...
public abstract class NewNetworkBoundUpdateResource<CacheObject> {

    private static final String TAG = "KMNewNtwrkBnddUpdateRes";
    ...
    public NewNetworkBoundUpdateResource(AppExecutors2 appExecutors, String returnString) {
