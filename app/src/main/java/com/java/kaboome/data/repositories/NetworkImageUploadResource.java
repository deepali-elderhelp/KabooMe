...
//3. Else, do nothing
public abstract class NetworkImageUploadResource<CacheObject> {

    private static final String TAG = "KMNetworkImgUploadRes";
    ...
    public NetworkImageUploadResource(AppExecutors2 appExecutors, String returnString) {
    ...
    @WorkerThread
    protected abstract boolean shouldUpload();
