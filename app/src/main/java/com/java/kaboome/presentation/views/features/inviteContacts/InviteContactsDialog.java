 ...
 */
public class InviteContactsDialog extends DialogFragment implements InvitationContactListener, SearchView.OnQueryTextListener {
...
//    private MenuItem itemSearch;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.dialog_invite_contacts, container, false);

        doneButton = rootView.findViewById(R.id.invite_contacts_done_button);
        doneButton.setOnClickListener(selectionDone);

        closeButton = rootView.findViewById(R.id.contact_list_close_button);
...
//        searchView = new SearchView(getContext());
        searchView = rootView.findViewById(R.id.search_contact_list);
...
//        searchView.setSubmitButtonEnabled(true);
        ...
        searchView.setMaxWidth(((Double)(getDialog().getWindow().getAttributes().width * 0.7)).intValue());

//        MenuItemCompat.setActionView(itemSearch, searchView);

//        itemSearch.setActionView(searchView);
        navController = NavHostFragment.findNavController(InviteContactsDialog.this);
        return rootView;
    }
...
//                NavHostFragment.findNavController(InviteContactsDialog.this).navigate(R.id.action_inviteContactsFragment_to_inviteContactsMessageDialog);
                NavHostFragment.findNavController(InviteContactsDialog.this).navigate(R.id.action_inviteContactsDialog_to_inviteContactsMessageDialog);
            }
            else{
                if(onlySelfUser){
            ...
            builder.setTitle("Invitations Sent").setMessage("Invited contacts would get notified of the invitations soon")
                    .setNeutralButton("Got It", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            NavController navController = NavHostFragment.findNavController(InviteContactsDialog.this);
