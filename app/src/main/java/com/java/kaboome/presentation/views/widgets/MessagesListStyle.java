...
public class MessagesListStyle extends Style {
    ...
    private int incomingAliasTextColor;
    private int incomingAliasTextSize;
    private int incomingAliasTextStyle;
    ...
    static MessagesListStyle parse(Context context, AttributeSet attrs) {
        ...
        style.incomingDefaultBubbleColor = typedArray.getColor(R.styleable.MessagesList_incomingDefaultBubbleColor,
                style.getColor(R.color.incomingMessageBubbleColor));
        ...
        style.incomingTextColor = typedArray.getColor(R.styleable.MessagesList_incomingTextColor,
                style.getColor(R.color.incomingTextColor));
        ...
        style.incomingAliasTextColor = typedArray.getColor(R.styleable.MessagesList_incomingAliasTextColor,
                style.getColor(R.color.incomingAliasTextColor));
        style.incomingAliasTextSize = typedArray.getDimensionPixelSize(R.styleable.MessagesList_incomingAliasTextSize,
                style.getDimension(R.dimen.message_alias_text_size));
        style.incomingAliasTextStyle = typedArray.getInt(R.styleable.MessagesList_incomingAliasTextStyle, Typeface.BOLD);

        style.incomingTimeTextColor = typedArray.getColor(R.styleable.MessagesList_incomingTimeTextColor,
                style.getColor(R.color.incomingTimeTextColor));
        ...
        style.outcomingDefaultBubbleColor = typedArray.getColor(R.styleable.MessagesList_outcomingDefaultBubbleColor,
                style.getColor(R.color.outgoingMessageBubbleColor));
    ...
    public int getIncomingAliasTextColor() {
        return incomingAliasTextColor;
    }

    public int getIncomingAliasTextSize() {
        return incomingAliasTextSize;
    }

    public int getIncomingAliasTextStyle() {
        return incomingAliasTextStyle;
    }
