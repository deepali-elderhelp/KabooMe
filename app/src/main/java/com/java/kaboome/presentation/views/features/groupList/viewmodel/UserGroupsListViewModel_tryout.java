...
//import com.java.kaboome.domain.usecases.GetGroupMessagesAfterLastAccessSingleUseCase;
...
//import com.java.kaboome.domain.usecases.GetLastGroupMessagesInCacheUseCase;
...
//import com.java.kaboome.service.SyncMessagesFromServer;
//
...
//
//
//public class UserGroupsListViewModel_tryout extends AndroidViewModel {
//
...
//    private GetLastGroupMessagesInCacheUseCase getLastGroupMessagesInCacheUseCase;
...
//    private Map<String, MutableLiveData<UserGroupConversationModel>> mutableLiveDataForEachGroupConversation = new HashMap<>();
//
//
//
//    public UserGroupsListViewModel_tryout(@NonNull Application application) {
//        super(application);
//        context = application;
//
...
//        getLastGroupMessagesInCacheUseCase = new GetLastGroupMessagesInCacheUseCase(messagesListRepository);
//
...
//                                Intent serviceIntent = new Intent(context, SyncMessagesFromServer.class);
...
//    }
//
//    private void addGroupConversationsNeededDataTriggers(@NonNull DomainResource<List<DomainUserGroupConversation>> listDomainResourceConversation) {
//
//        for(int i=0; i< listDomainResourceConversation.data.size(); i++){
//
//            UserGroupConversationModel userGroupConversationModel = UserGroupConversationModelMapper.getUserModelFromDomain(listDomainResourceConversation.data.get(i));
//
...
//            }
//
//            MutableLiveData<UserGroupConversationModel> userGroupConversationModelMutableLiveData = mutableLiveDataForEachGroupConversation.get(userGroupConversationModel.getOtherUserId());
//            if(userGroupConversationModelMutableLiveData == null){
//                userGroupConversationModelMutableLiveData = new MutableLiveData<>();
//                mutableLiveDataForEachGroupConversation.put(userGroupConversationModel.getOtherUserId(), userGroupConversationModelMutableLiveData);
//
//                LiveData<UserGroupConversationModel> userGroupConversationReturnedLiveData = applyTransformationsForEachGroupConversation(userGroupConversationModelMutableLiveData);
////
...
//                    @Override
//                    public void onChanged(UserGroupConversationModel userGroupConversationModel1) {
////                        Log.d(TAG, "onChanged: eachGroupLiveData source changed for Group "+userGroupModel.getGroupId());
//                        eachGroupConversationLiveData.setValue(userGroupConversationModel1);
//                    }
//                });
//            }
//
//            userGroupConversationModelMutableLiveData.setValue(UserGroupConversationModelMapper.getUserModelFromDomain(listDomainResourceConversation.data.get(i)));
//        }
//    }
//
...
//
//                       multipleFunctions.addSource(Transformations.switchMap(getGroupMessagesAfterLastAccessUseCase.execute(GetGroupMessagesAfterLastAccessUseCase.Params.getMessagesAfterLastAccessForGroup(input.getGroupId(), groupLastMessageSeenTS)),
//                                new Function<List<DomainMessage>, LiveData<List<DomainMessage>>>() {
//                                    @Override
//                                    public LiveData<List<DomainMessage>> apply(List<DomainMessage> input) {
//                                        return null;
//                                    }
...
//                        });
//
//                        multipleFunctions.addSource(getLastGroupMessagesInCacheUseCase.execute(GetLastGroupMessagesInCacheUseCase.Params.forGroup(input.getGroupId())), new Observer<DomainMessage>() {
//                            @Override
...
//    }
//
//    private LiveData<UserGroupConversationModel> applyTransformationsForEachGroupConversation(MutableLiveData<UserGroupConversationModel> userGroupModelConversationMutableLiveData) {
//        return Transformations.switchMap(userGroupModelConversationMutableLiveData, new Function<UserGroupConversationModel, LiveData<UserGroupConversationModel>>() {
//            @Override
