...
public class MessageInput extends RelativeLayout
    ...
    protected MessageInputStyle style;
    ...
    public void setUrgentMessageColors(){
        ViewCompat.setBackground(messageSendButton, style.getUrgentInputButtonBackground());
    }

    public void setNormalMessageColors(){
    ...
    public void setInitialMessageColors(){
...
//        MessageInputStyle style = MessageInputStyle.parse(context, attrs);
        ...
        //I did it because then the padding for the view is so much that the attachment button
        //does not go to the left, it kinda shows in the center with input field right next to it
        //padding for bottom and top needed, hence adding them, not left and right.
//        if (getPaddingLeft() == 0
//                && getPaddingRight() == 0
//                && getPaddingTop() == 0
//                && getPaddingBottom() == 0) {
...
//        }
    ...
    public interface InputListener {
        ...
        /**
         * Fires when user presses 'send_background' button.
         *
