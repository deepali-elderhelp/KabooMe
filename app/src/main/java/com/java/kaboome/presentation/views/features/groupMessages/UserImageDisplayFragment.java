 ...
 */
public class UserImageDisplayFragment extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    private ImageView makeAdminImage;
    private TextView makeAdminLink;
    private TextView removeUserLink;
    private Message message;
    private boolean currentUserIsAdmin = true;
    Handler handler = new Handler(); //needed for Glide
    private NavController navController;


    public UserImageDisplayFragment() {
...
//        currentUserIsAdmin = getArguments().getBoolean("currentUserIsAdmin");
        navController = NavHostFragment.findNavController(UserImageDisplayFragment.this);
    }
...
//                BottomSheetBehavior.from(bottomSheet).setPeekHeight((int)((Resources.getSystem().getDisplayMetrics().heightPixels) * 0.7) );
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_group_user_display_dialog, container, false);
    ...
    public void onResume() {
        ...
        //set field values
        userAlias.setText(message.getAlias());
        userRole.setText(message.getRole());
