...
public class ImageHelper_working_for_groip {

    private static final String TAG = "KMImageHelper";
    private static ImageHelper_working_for_groip instance;

    private ImageHelper_working_for_groip() {


    }

    public static ImageHelper_working_for_groip getInstance(){
        if(instance == null){
            instance = new ImageHelper_working_for_groip();
        }
        return instance;
    }
    ...
    public void loadGroupImageTN(String groupId, Long timeStampFromLocalDB, final RequestManager requestManager, final Drawable placeholder, final Drawable errorBitmap, final Handler handler, final ImageView imageView, final ProgressBar progressBar){
