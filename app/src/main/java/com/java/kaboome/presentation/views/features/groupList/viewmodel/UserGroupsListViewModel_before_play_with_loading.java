...
//import com.java.kaboome.domain.usecases.GetLastWholeGroupMessagesInCacheUseCase;
...
//
//
//public class UserGroupsListViewModel_before_play_with_loading extends AndroidViewModel {
//
...
//    private GetLastWholeGroupMessagesInCacheUseCase getLastWholeGroupMessagesInCacheUseCase;
...
//
//
//    public UserGroupsListViewModel_before_play_with_loading(@NonNull Application application) {
//        super(application);
//        context = application;
//
...
//        getLastWholeGroupMessagesInCacheUseCase = new GetLastWholeGroupMessagesInCacheUseCase(messagesListRepository);
//
...
//                                            WorkerBuilderHelper.callUpdateCacheClearTSWorker(userGroupModel.getGroupId(), (new Date()).getTime(), false, false);
//                                            WorkerBuilderHelper.callDeleteGroupAttachmentsWorker(userGroupModel.getGroupId(), "Group");
//                                        }
//                                    }
////                                }
//
...
//                        });
//
//                        multipleFunctions.addSource(getLastWholeGroupMessagesInCacheUseCase.execute(GetLastWholeGroupMessagesInCacheUseCase.Params.forGroup(input.getGroupId())), new Observer<DomainMessage>() {
//                            @Override
