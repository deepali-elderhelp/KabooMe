...
import com.java.kaboome.presentation.views.widgets.commons.Style;
...
class MessageInputStyle extends Style {
    ...
    private int inputUrgentButtonDefaultBgColor;
    private int inputUrgentButtonDefaultBgPressedColor;
    private int inputUrgentButtonDefaultBgDisabledColor;
    ...
    static MessageInputStyle parse(Context context, AttributeSet attrs) {
        ...
        style.attachmentButtonDefaultIconColor = typedArray.getColor(R.styleable.MessageInput_attachmentButtonDefaultIconColor,
                style.getColor(R.color.grey_300));
        style.attachmentButtonDefaultIconPressedColor = typedArray.getColor(R.styleable.MessageInput_attachmentButtonDefaultIconPressedColor,
                style.getColor(R.color.grey_400));
        ...
        style.attachmentButtonWidth = typedArray.getDimensionPixelSize(R.styleable.MessageInput_attachmentButtonWidth, style.getDimension(R.dimen.attachment_button_width));
        style.attachmentButtonHeight = typedArray.getDimensionPixelSize(R.styleable.MessageInput_attachmentButtonHeight, style.getDimension(R.dimen.attachment_button_height));
        style.attachmentButtonMargin = typedArray.getDimensionPixelSize(R.styleable.MessageInput_attachmentButtonMargin, style.getDimension(R.dimen.attachment_button_margin));
        ...
        style.inputUrgentButtonDefaultBgColor = typedArray.getColor(R.styleable.MessageInput_inputButtonDefaultBgColor,
                style.getColor(R.color.urgent_background));
        style.inputUrgentButtonDefaultBgPressedColor = typedArray.getColor(R.styleable.MessageInput_inputButtonDefaultBgPressedColor,
                style.getColor(R.color.urgent_background_dark));
        style.inputUrgentButtonDefaultBgDisabledColor = typedArray.getColor(R.styleable.MessageInput_inputButtonDefaultBgDisabledColor,
                style.getColor(R.color.white_four));
    ...
    protected Drawable getAttachmentButtonBackground() {
        if (attachmentButtonBackground == -1) {
            return getSelector(attachmentButtonDefaultBgColor, attachmentButtonDefaultBgPressedColor,
                    attachmentButtonDefaultBgDisabledColor, R.drawable.attachment_background);
        } else {
    ...
    protected Drawable getAttachmentButtonIcon() {
        if (attachmentButtonIcon == -1) {
            return getSelector(attachmentButtonDefaultIconColor, attachmentButtonDefaultIconPressedColor,
                    attachmentButtonDefaultIconDisabledColor, R.drawable.attachments_small);
        } else {
    ...
    protected Drawable getInputButtonBackground() {
        if (inputButtonBackground == -1) {
            return getSelector(inputButtonDefaultBgColor, inputButtonDefaultBgPressedColor,
                    inputButtonDefaultBgDisabledColor, R.drawable.send_background);
        } else {
            return getDrawable(R.drawable.send_background);
        }
    }

    protected Drawable getUrgentInputButtonBackground() {
        if (inputButtonBackground == -1) {
            return getSelector(inputUrgentButtonDefaultBgColor, inputUrgentButtonDefaultBgPressedColor,
                    inputUrgentButtonDefaultBgDisabledColor, R.drawable.send_background);
        } else {
            return getDrawable(R.drawable.send_background);
        }
    }
