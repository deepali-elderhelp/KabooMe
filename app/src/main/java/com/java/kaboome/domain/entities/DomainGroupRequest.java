...
public class DomainGroupRequest {
    ...
    private static final String TAG = "KMDomainGroupReqts";
    ...
    public DomainGroupRequest() {
    }

    public DomainGroupRequest(String groupId, String userId, String userAlias, String userRole, Long dateRequestMade, String requestMessage, Long imageUpdateTimestamp) {
